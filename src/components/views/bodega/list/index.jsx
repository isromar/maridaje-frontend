...
const TablaVinosBodega = ({ busquedaNombreVino, selectedOption }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await getDataPerfilBodega(
        apiUrl.vinos,
        busquedaNombreVino,
        selectedOption,
        bodegaId
      ...
      setVinosFiltrados(vinosFiltradosPorBodega); // Inicializa los vinos filtrados con todos los vinos
    } catch (error) {
...
export default TablaVinosBodega;
